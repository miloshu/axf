<template>
  <div class="home">
    ...
    <div class="main">
      <div class="category">
        <ul class="categories">
          <li v-for="(item, index) in classifys" :key="item.classify_id" @click="changeClassifys(item.classify_id)">
      ...
      <div class="productList" @click="hideProductList()">
        <div class="product-filter" :class="{'active': ranking||allCategories}">
          <div class="filter-titles">
            <div :class="{'active': allCategories}" @click.stop="toggleAllCategories()">
              <span>全部分类</span><var>&nbsp;</var>
            </div>
            <div :class="{'active': ranking}" @click.stop="toggleRanking()">
          ...
          <div class="filter-items" v-show="allCategories">
            <ul>
              ...
              <li v-for="(item, index) in activeClassifysProduct.cids" :key="index" :class="{'active': allCategoriesIndex === index}" @click="changeCids(index)">{{item.name}}</li>
            </ul>
          </div>
          <!-- 综合排序 -->
          <div class="filter-items" v-show="ranking">
            <ul>
              <li v-for="(item, index) in rankingList" :key="index" :class="{'active': activeRankingIndex === index}" @click="changeCids(index)">{{item}}</li>
            </ul>
          </div>
        </div>
...
export default {
  ...
  methods: {
    ...
    // 切换综合排序是否显示列表
    toggleRanking () {
      // 判断如果全部分类已经显示,那么将其改为隐藏,让只显示综合排序
...
// 封装排序的方法
  ...
  // ]
    ...
    // console.log(orderBy(arr,"price",false))
</script>
